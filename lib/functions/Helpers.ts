...
import type { IImplementationFunction } from './OverloadTree';
...
export class Builder {
  ...
  public static implementAll(op: (context: ICompleteSharedConfig) => E.SimpleSyncApplication): IImplementationFunction {
    return {
      sync: op,
      async: context => args => Promise.resolve(op(context)(args)),
    };
  }
  ...
  public set(argTypes: ArgumentType[],
    func: IImplementationFunction): Builder {
  ...
  public onUnary<T extends Term>(type: ArgumentType, op: (context: ICompleteSharedConfig) => (val: T) => Term):
  Builder {
    return this.set([ type ], Builder.implementAll(context => ([ val ]: [T]) => op(context)(val)));
  }

  public onUnaryTyped<T>(type: ArgumentType, op: (context: ICompleteSharedConfig) => (val: T) => Term): Builder {
    return this.set([ type ], Builder.implementAll(context =>
      ([ val ]: [E.Literal<T>]) => op(context)(val.typedValue)));
  }

  public onBinary<L extends Term, R extends Term>(types: ArgumentType[],
    op: (context: ICompleteSharedConfig) => (left: L, right: R) => Term): Builder {
    return this.set(types, Builder.implementAll(context => ([ left, right ]: [L, R]) => op(context)(left, right)));
  }

  public onBinaryTyped<L, R>(types: ArgumentType[],
    op: (context: ICompleteSharedConfig) => (left: L, right: R) => Term): Builder {
    return this.set(types, Builder.implementAll(context =>
  ...
  public onTernaryTyped<A1, A2, A3>(types: ArgumentType[],
    op: (context: ICompleteSharedConfig) => (a1: A1, a2: A2, a3: A3) => Term): Builder {
    return this.set(types, Builder.implementAll(context =>
      ([ a1, a2, a3 ]: [E.Literal<A1>, E.Literal<A2>, E.Literal<A3>]) =>
  ...
  public onTernary<
    ...
    A2 extends Term,
    A3 extends Term
  >(types: ArgumentType[], op: (context: ICompleteSharedConfig) => (a1: A1, a2: A2, a3: A3) => Term): Builder {
    return this.set(types, Builder.implementAll(context => ([ a1, a2, a3 ]: [A1, A2, A3]) => op(context)(a1, a2, a3)));
  }

  public onQuaternaryTyped<A1, A2, A3, A4>(types: ArgumentType[],
    op: (context: ICompleteSharedConfig) => (a1: A1, a2: A2, a3: A3, a4: A4) => Term): Builder {
    return this.set(types, Builder.implementAll(context =>
  ...
  public onTerm1(op: (context: ICompleteSharedConfig) => (term: Term) => Term): Builder {
    return this.set([ 'term' ], Builder.implementAll(context => ([ term ]: [Term]) => op(context)(term)));
  }

  public onLiteral1<T>(op: (context: ICompleteSharedConfig) => (lit: E.Literal<T>) => Term): Builder {
    return this.set([ 'literal' ], Builder.implementAll(context => ([ term ]: [E.Literal<T>]) => op(context)(term)));
  }

  public onBoolean1(op: (context: ICompleteSharedConfig) => (lit: E.BooleanLiteral) => Term): Builder {
    return this
      .set([ C.TypeURL.XSD_BOOLEAN ], Builder.implementAll(context =>
        ([ lit ]: [E.BooleanLiteral]) => op(context)(lit)));
  }

  public onBoolean1Typed(op: (context: ICompleteSharedConfig) => (lit: boolean) => Term): Builder {
    return this
      .set([ C.TypeURL.XSD_BOOLEAN ], Builder.implementAll(context =>
        ([ lit ]: [E.BooleanLiteral]) => op(context)(lit.typedValue)));
  }

  public onString1(op: (context: ICompleteSharedConfig) => (lit: E.Literal<string>) => Term): Builder {
    return this
      .set([ C.TypeURL.XSD_STRING ], Builder.implementAll(context =>
        ([ lit ]: [E.Literal<string>]) => op(context)(lit)));
  }

  public onString1Typed(op: (context: ICompleteSharedConfig) => (lit: string) => Term): Builder {
    return this
      .set([ C.TypeURL.XSD_STRING ], Builder.implementAll(context =>
        ([ lit ]: [E.Literal<string>]) => op(context)(lit.typedValue)));
  }

  public onLangString1(op: (context: ICompleteSharedConfig) => (lit: E.LangStringLiteral) => Term): Builder {
    return this
      .set([ C.TypeURL.RDF_LANG_STRING ], Builder.implementAll(context =>
        ([ lit ]: [E.LangStringLiteral]) => op(context)(lit)));
  }

  public onStringly1(op: (context: ICompleteSharedConfig) => (lit: E.Literal<string>) => Term): Builder {
    return this
      .set([ C.TypeAlias.SPARQL_STRINGLY ], Builder.implementAll(context =>
        ([ lit ]: [E.Literal<string>]) => op(context)(lit)));
  }

  public onStringly1Typed(op: (context: ICompleteSharedConfig) => (lit: string) => Term): Builder {
    return this
      .set([ C.TypeAlias.SPARQL_STRINGLY ], Builder.implementAll(context =>
        ([ lit ]: [E.Literal<string>]) => op(context)(lit.typedValue)));
  }

  public onNumeric1(op: (context: ICompleteSharedConfig) => (val: E.NumericLiteral) => Term): Builder {
    return this
      .set([ C.TypeAlias.SPARQL_NUMERIC ], Builder.implementAll(context =>
        ([ val ]: [E.NumericLiteral]) => op(context)(val)))
      .invalidLexicalForm([ C.TypeAlias.SPARQL_NON_LEXICAL ], 1);
  }

  public onDateTime1(op: (context: ICompleteSharedConfig) => (date: E.DateTimeLiteral) => Term): Builder {
    return this
      .set([ C.TypeURL.XSD_DATE_TIME ], Builder.implementAll(context =>
        ([ val ]: [E.DateTimeLiteral]) => op(context)(val)))
      .invalidLexicalForm([ C.TypeAlias.SPARQL_NON_LEXICAL ], 1);
  }
   ...
   */
  public numericConverter(op: (context: ICompleteSharedConfig) => (val: number) => number): Builder {
    const evalHelper = (context: ICompleteSharedConfig) => (arg: Term): number =>
   ...
   */
  public arithmetic(op: (context: ICompleteSharedConfig) => (left: number, right: number) => number): Builder {
    const evalHelper = (context: ICompleteSharedConfig) => (left: Term, right: Term): number =>
  ...
  public numberTest(test: (context: ICompleteSharedConfig) => (left: number, right: number) => boolean): Builder {
    return this.numeric(Builder.implementAll(context => ([ left, right ]: E.NumericLiteral[]) => {
      const result = test(context)(left.typedValue, right.typedValue);
      return bool(result);
    }));
  }

  public stringTest(test: (context: ICompleteSharedConfig) => (left: string, right: string) => boolean): Builder {
    return this
      .set(
        [ C.TypeURL.XSD_STRING, C.TypeURL.XSD_STRING ],
        Builder.implementAll(context => ([ left, right ]: E.StringLiteral[]) => {
          const result = test(context)(left.typedValue, right.typedValue);
          return bool(result);
        }),
      )
  ...
  public booleanTest(test: (context: ICompleteSharedConfig) => (left: boolean, right: boolean) => boolean): Builder {
    return this
      .set(
        [ C.TypeURL.XSD_BOOLEAN, C.TypeURL.XSD_BOOLEAN ],
        Builder.implementAll(context => ([ left, right ]: E.BooleanLiteral[]) => {
          const result = test(context)(left.typedValue, right.typedValue);
          return bool(result);
        }),
      )
  ...
  public dateTimeTest(test: (context: ICompleteSharedConfig) => (left: Date, right: Date) => boolean): Builder {
    return this
      .set(
        [ C.TypeURL.XSD_DATE_TIME, C.TypeURL.XSD_DATE_TIME ],
        Builder.implementAll(context => ([ left, right ]: E.DateTimeLiteral[]) => {
          const result = test(context)(left.typedValue, right.typedValue);
          return bool(result);
        }),
      )
  ...
  public numeric(op: IImplementationFunction): Builder {
    return this
  ...
  public invalidLexicalForm(types: ArgumentType[], index: number): Builder {
    return this.set(types, Builder.implementAll(() => (args: Term[]): E.TermExpression => {
